...
<head>
    ...
    <title>IDC — Registration Confirmed</title>
</head>
<body style="margin:0;padding:0;background-color:#eef1f7;font-family:'Segoe UI',Arial,Helvetica,sans-serif;">
    <div style="display:none;max-height:0;overflow:hidden;">Your sample #{{ $Maildata['Sampleno'] }} has been registered at IDC Diagnostic Center.</div>
                ...
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:18px;overflow:hidden;box-shadow:0 10px 40px rgba(15,23,42,.12);">
                    ...
                    <tr>
                        <td style="padding:34px 40px 0;text-align:center;">
                            <span style="display:inline-block;background-color:#eef2ff;color:#4f46e5;font-size:12px;font-weight:800;letter-spacing:1px;text-transform:uppercase;padding:8px 18px;border-radius:999px;">✓ Registration Confirmed</span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:22px 40px 0;">
                            ...
                            <p style="margin:12px 0 0;font-size:14px;line-height:1.7;color:#475569;text-align:center;">
                                Your sample has been successfully registered at the IDC Diagnostic Center.
                                Our laboratory team has received it and it is now queued for AI-assisted histopathology analysis.
                            </p>
                        </td>
                    </tr>
                                    ...
                                    <td style="padding:8px 22px;">
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="padding:11px 0;font-size:14px;font-weight:800;color:#4f46e5;text-align:right;border-bottom:1px solid #edf0f6;">IDC-{{ str_pad($Maildata['ID'], 5, '0', STR_PAD_LEFT) }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="padding:11px 0;font-size:12px;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:1px;">Registered By</td>
                                                <td style="padding:11px 0;font-size:14px;font-weight:700;color:#0f172a;text-align:right;">{{ $Maildata['Addedby'] }} (Laboratory Technician)</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center" width="33%" style="padding:0 4px;">
                                        <div style="width:34px;height:34px;line-height:34px;border-radius:50%;background-color:#4f46e5;color:#ffffff;font-weight:800;font-size:14px;margin:0 auto;">✓</div>
                                        <div style="font-size:11px;font-weight:800;color:#0f172a;margin-top:8px;">Registered</div>
                                    </td>
                                    <td align="center" width="33%" style="padding:0 4px;">
                                        <div style="width:34px;height:34px;line-height:34px;border-radius:50%;background-color:#e2e8f0;color:#64748b;font-weight:800;font-size:14px;margin:0 auto;">2</div>
                                        <div style="font-size:11px;font-weight:800;color:#94a3b8;margin-top:8px;">Lab Analysis</div>
                                    </td>
                                    <td align="center" width="33%" style="padding:0 4px;">
                                        <div style="width:34px;height:34px;line-height:34px;border-radius:50%;background-color:#e2e8f0;color:#64748b;font-weight:800;font-size:14px;margin:0 auto;">3</div>
                                        <div style="font-size:11px;font-weight:800;color:#94a3b8;margin-top:8px;">Result Emailed</div>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#fffbeb;border:1px solid #fde68a;border-radius:12px;">
                                <tr>
                                    <td style="padding:16px 20px;font-size:12px;line-height:1.7;color:#92400e;">
                                        ...
                                        • Your result will be delivered to this email address — no need to call.<br>
                                        • Please keep your sample number <strong>#{{ $Maildata['Sampleno'] }}</strong> for any inquiry.<br>
                                        • Processing usually completes within a few working days.
                                    </td>
                                </tr>
                            </table>
                        </td>
